//=========================================================================
// riscvlong Simulation with Inclusive L1/L2/L3 Cache Hierarchy
//=========================================================================
// Drop-in replacement for riscvlong-cache-sim.v that uses the three-level
...
`include "inclcache-InclusiveCacheHier.v"
...
module riscv_inclcache_sim;
  ...
  // Port 1 unused; its request is tied low.
  //----------------------------------------------------------------------
  ...
  initial begin
    ...
    if ($value$plusargs("vcd=%d", vcd)) begin
      vcd_filename = {exe_filename[983:32], "-inclcache.vcd"};
